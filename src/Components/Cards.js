          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                HTML, CSS, JavaScript, PHP<br></br>• Database: MySQL<br></br>•
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                langugae that is designed to have as few implementation
                dependencies as possible<br></br>Proficient in problem solving
                skills and DSA
              </p>
            </div>
          </div>
        ...
        <div className="col-md-4" id="cards">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                High-level programming language. Ideal for web, data analysis,
                AI, automation. And Machine Learning algorithms, deep learnig
                algorihtms. Libraries like numpy, pandas, tensorflow
              </p>
            </div>
          </div>
        </div>
